...
parser.add_argument('--voc_root', default='./VOCdevkit',
...
if __name__ == '__main__':
    ...
    chkpt = torch.load(args.trained_model, map_location=device)
    ...
    with torch.no_grad():
        test_net(args.save_folder, net, args.cuda, dataset,
             BaseTransform((416, 416)), args.top_k,
